...
struct CategorieBarChartHost: NSViewRepresentable {
    ...
    final class Coordinator: NSObject, ChartViewDelegate {
        var parent: CategorieBarChartHost
        init(parent: CategorieBarChartHost) { self.parent = parent }
        ...
        func chartValueSelected(_ chartView: ChartViewBase, entry: ChartDataEntry, highlight: Highlight) {
            ...
            let full = ListTransactionsManager.shared.getAllData(from: nil, to: nil, ascending: true)
